    ...
    <div>
      <section className="relative h-[600px] flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: 'url(./assets/homepage/background.jpg)',
            filter: 'brightness(0.3)',
          }}
        />
        <div className="relative text-center space-y-6">
          <h1 className="text-6xl font-bold text-[#ff6b6b] mb-4">
      ...
      <section className="py-16">
        <h2 className="text-4xl font-bold text-center mb-12">The History of Gaming</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {gamingEras.map((era) => (
            <div
              key={era.era}
              className="bg-[#1a1a1a] p-6 rounded-lg hover:transform hover:scale-105 transition-transform cursor-pointer"
